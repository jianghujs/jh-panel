...
class system_api:
    ...
    def updateServerCodeApi(self):
        mw.execShell("cd /www/server/jh-panel && pip3 install -r /www/server/jh-panel/requirements.txt")
    ...
    def setNotifyValue(self, notify_value):
        ...
        keepalived_status_notice = notify_value.get('keepalived_status_notice', '')
        ...
        if keepalived_status_notice != '':
            config_data['keepalived_status_notice'] = int(keepalived_status_notice)
