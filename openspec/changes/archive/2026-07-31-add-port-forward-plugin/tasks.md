...
- [x] 1.3 Add default forwarding examples matching the current firewall management addresses
...
- [x] 3.4 Verify apply/delete/status/check behavior against the two default forwarding entries
