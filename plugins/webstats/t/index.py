...
if __name__ == "__main__":
    os.system('cd /Users/midoks/Desktop/mwdev/server/jh-panel/plugins/webstats && sh install.sh uninstall 0.2.2 && sh install.sh install 0.2.2')
    os.system('cd /Users/midoks/Desktop/mwdev/server/jh-panel/ && python3 plugins/openresty/index.py stop && python3 plugins/openresty/index.py start')
    test_start()
