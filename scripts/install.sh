...
if [ "$netEnvCn" == "cn" ]; then
  wget -O ${OSNAME}_cn.sh https://gitee.com/jianghujs/jh-panel/raw/master/scripts/switch_apt_source.sh && bash switch_apt_source.sh 2
  wget -O ${OSNAME}_cn.sh https://gitee.com/jianghujs/jh-panel/raw/master/scripts/install/${OSNAME}_cn.sh && bash ${OSNAME}_cn.sh
else
  wget -O ${OSNAME}_cn.sh https://gitee.com/jianghujs/jh-panel/raw/master/scripts/switch_apt_source.sh && bash switch_apt_source.sh 1
