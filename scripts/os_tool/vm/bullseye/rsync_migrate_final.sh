...
echo "- 【$project_dir】 --->  【$target_project_dir】"
echo "==========================================================="
echo "======================目标服务器操作指引====================="
echo "1. 在目标服务器执行xtrabackup文件恢复"
echo "xtrabackup文件已经同步到目标服务器的【$target_xtrabackup_dir】目录下，请在目标服务器的江湖面板-打开xtrabackup插件-mysql备份，找到【$xtrabackup_file】，点击恢复完成数据恢复工作"
echo "==========================================================="
