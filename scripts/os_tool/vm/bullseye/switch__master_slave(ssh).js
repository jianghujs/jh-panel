...
async function switchMasterSlave() {
  try {
    ...
    await masterQuery("SET GLOBAL super_read_only = ON; SET GLOBAL read_only = ON; FLUSH PRIVILEGES;");
    await slaveQuery("SET GLOBAL super_read_only = ON; SET GLOBAL read_only = ON; FLUSH PRIVILEGES;");
    ...
    await slaveQuery("SET GLOBAL super_read_only = OFF; SET GLOBAL read_only = OFF; FLUSH PRIVILEGES;");
